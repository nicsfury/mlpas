...
class OriginAreaFewItem: UIViewController{
    //MARK: - Properties
    var models = [String]()
...
extension OriginAreaFewItem: UITableViewDelegate{
...
extension OriginAreaFewItem: UITableViewDataSource{
...
extension OriginAreaFewItem: UISearchBarDelegate{
