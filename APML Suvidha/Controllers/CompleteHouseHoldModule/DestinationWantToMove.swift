...
import Foundation
import UIKit
class DestinationWantToMove: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        getCityLocation(name: "destination")
    }
...
extension DestinationWantToMove: UITableViewDelegate{
...
extension DestinationWantToMove: UITableViewDataSource{
...
extension DestinationWantToMove: UISearchBarDelegate{
