//
//  SurveyTimeComplete.swift
//  APML Suvidha
//
//  Created by Nishant Gupta on 23/03/18.
...
class SurveyTimeComplete: UIViewController{
    ...
    @IBAction func timeClcikedBtn(_ sender: Any) {
        ...
        case 0:
             ...
             let AddressCompleteVC = SubmitStepComplete.instantiate(fromAppStoryboard: .CompleteHouseHoldMain)
