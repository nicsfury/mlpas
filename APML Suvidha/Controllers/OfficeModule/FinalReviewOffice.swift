...
class FinalReviewOffice: UIViewController{
...
extension FinalReviewOffice: UITableViewDelegate{
...
extension FinalReviewOffice: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            let cell1 = tableView.dequeueReusableCell(withIdentifier: "first") as! FinalReviewFirstOfficeTableCell
            cell1.setUpLayout()
            cell = cell1
        }else{
            let cell1 = tableView.dequeueReusableCell(withIdentifier: "second") as! FinalReviewSecondOfficeTableCell
            cell = cell1
        }
        return cell
    }
