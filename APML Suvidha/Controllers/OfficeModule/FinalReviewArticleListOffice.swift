//
//  FinalReviewArticleListOffice.swift
//  APML Suvidha
//
...
class FinalReviewArticleListOffice: UIViewController{
    //MARK: - Properties
...
extension FinalReviewArticleListOffice: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        case "":
            let cell3 = tableView.dequeueReusableCell(withIdentifier: "third") as! ThirdFinalReviewCustomCellOffice
            
            cell = cell3
            break
        case "0":
            let cell2 = tableView.dequeueReusableCell(withIdentifier: "second") as! SecondFinalReviewCustomCellOffice
            
            cell = cell2
        case "1":
            let cell1 = tableView.dequeueReusableCell(withIdentifier: "first") as! FinalReviewArticleCustomCellOffice
            cell = cell1
        default:
            break
        }
...
extension FinalReviewArticleListOffice: UITableViewDelegate{
