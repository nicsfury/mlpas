...
class ArticleListOffice: UIViewController{
    ...
    @IBAction func viewArticleDetails(_ sender: Any) {
        let articledetails = ArticleDetailsOffice.instantiate(fromAppStoryboard: .OfficeStoryboardMain)
        self.navigationController?.pushViewController(articledetails, animated: true)
    }
}

//MARK: - UICollectionViewDelegateFlowLayout Method
extension ArticleListOffice: UICollectionViewDelegateFlowLayout{
...
extension ArticleListOffice: UICollectionViewDataSource{
...
extension ArticleListOffice: UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let articleDetailsComplete = ArticleDetailsOffice.instantiate(fromAppStoryboard: .OfficeStoryboardMain)
