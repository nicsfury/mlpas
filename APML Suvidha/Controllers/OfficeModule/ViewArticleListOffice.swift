...
class ViewArticleListOffice: UIViewController{
    //MARK: - Properties
    ...
    func deleteArticleItem(listArticle: ViewArticleFinalReview, cell: ViewArticleSecondTableViewCell){
...
extension ViewArticleListOffice: UITableViewDelegate{
    
}
//MARK: - UITableViewDataSource Method
extension ViewArticleListOffice: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if model.catStatus == "1"{
            let cell1 = tableView.dequeueReusableCell(withIdentifier: "cellfirst") as! ViewArticleFirstOfficeTableviewCell
            cell1.setUpLayout(list: model, cell: cell1)
            cell = cell1
        }else{
            let cell2 = tableView.dequeueReusableCell(withIdentifier: "cell") as! ViewArticleSecondTableViewCell
    ...
    @objc func deletebuttonPressed(_ sender: AnyObject) {
        ...
        let cell = tableview.cellForRow(at: indexPath)  as? ViewArticleSecondTableViewCell
